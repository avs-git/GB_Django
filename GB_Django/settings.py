...
SOCIAL_AUTH_VK_OAUTH2_SCOPE = ['email', 'user_id']

SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = config.get('OAUTH2', 'GOOGLE_PLUS_KEY')
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = config.get('OAUTH2', 'GOOGLE_PLUS_SECRET')
